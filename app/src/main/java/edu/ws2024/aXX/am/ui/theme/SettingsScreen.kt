...
fun SettingsScreen(navController: NavController) {
    Column(
        ...
        // Skier Image (put skier.png in res/drawable)
        Image(
        ...
        // Example slider (e.g., volume or difficulty)
        ...
        Button(
            ...
            modifier = Modifier
                .fillMaxWidth(0.5f)
                .height(60.dp),
            colors = ButtonDefaults.buttonColors(containerColor = Color(0xFF87CEFA)) // light blue
        ) {
